...
<section id="kantin" class="divider"></section>
    <section>
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <p class="font-22">RSUD Ciamis memiliki kantin yang siap melayani baik pasien maupun pengunjung:</p>
                        <ul class="list check font-20">
                            <li>Menu sehat bervariatif.</li>
                            <li>Buka 24 Jam.</li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="border-2px border-theme-colored p-10">
                            <img class="img-fullwidth" style="max-width: 100%;" alt="" src="assets/images/kantin.jpg">
                        </div>
                    </div>
                </div>
            </div>
