...
<div class="main-content">
    <section id="indeks" class="divider">
    </section>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="border-left-2px border-theme-colored mt-60 pl-15">
                            <h2 class="text-theme-colored font-36 mt-0 mb-0">Indeks Kepuasan Masyarakat<br></h2>
                        </div>
                        <!-- Menampilkan Gambar alur Rawat Jalan -->
                        <img src="\assets\images\indeks.jpeg" alt="Indeks Kepuasan Masyarakat">
                        <br><br>
                    </div>
                </div>
            </div>
