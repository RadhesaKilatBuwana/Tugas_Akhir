...
<head>
    ...
    <title>Hak & Kewajiban Pasien</title>
    <!-- Include jQuery -->
...
<div class="main-content">
    <section id="pasien" class="divider">
    </section>
    <section>
        <div class="container pt-0 pb-50">
            <h1><br>Hak & Kewajiban Pasien<br><br></h1>
            <?php
            $pdfpath = 'assets/dokumen/hak_kewajiban_pasien.pdf';
            // Membaca dan menampilkan pdf
            echo '<embed src="' . $pdfpath . '" type="application/pdf" width="auto" height="auto" />';
            ?>
            <h1><br><br><br></h1>
        </div>
    </section>
