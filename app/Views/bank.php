...
<section id="bank" class="divider"></section>
    <section>
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <p class="font-22">RSUD Ciamis bekerja sama dengan bank BJB untuk memberikan keuntungan kepada pasien, seperti:</p>
                        <ul class="list check font-20">
                            <li>Memberikan kemudahan transaksi keuangan.</li>
                            <li>Administrasi yang efektif.</li>
                            <li>Dukungan finansial khusus untuk kebutuhan medis.</li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="border-2px border-theme-colored p-10">
                            <img class="img-fullwidth" style="max-width: 100%;" alt="" src="assets/images/bank.jpg">
                        </div>
                    </div>
                </div>
            </div>
