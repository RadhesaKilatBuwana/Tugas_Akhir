...
<div class="main-content">
    <section id="lalu-lintas" class="divider">
    </section>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="border-left-2px border-theme-colored mt-60 pl-15">
                            <h2 class="text-theme-colored font-36 mt-0 mb-0">Alur Penjaminan Kecelakaan Lalu Lintas</h2>
                        </div>
                        <br><br>
                        <!-- Menampilkan Gambar alur Rawat Jalan -->
                        <img src="\assets\images\alur\alur_kecelakaan.jpg" alt="Alur Penjaminan Kecelakaan LaLin" style="width:100%; height:auto;">
                        <br><br>
                    </div>
                </div>
            </div>
