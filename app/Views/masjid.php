...
<section id="masjid" class="divider"></section>
    <section>
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <p class="font-22">RSUD Ciamis memiliki masjid siap pakai untuk ibadah kaum muslimin:</p>
                        <ul class="list check font-20">
                            <li>Kapasitas 120 Orang.</li>
                            <li>Toilet Bersih.</li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="border-2px border-theme-colored p-10">
                            <img class="img-fullwidth" style="max-width: 100%;" alt="" src="assets/images/masjid.jpg">
                        </div>
                    </div>
                </div>
            </div>
