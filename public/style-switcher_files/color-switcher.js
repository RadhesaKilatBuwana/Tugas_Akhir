...
jQuery(document).ready(function($) {
    ...
    $('#switcher-theme-custom-color li a').on('click', function(e) {
        ...
        $("#link-colors-style").attr("href", "assets/"+theme_skin_folder_url + color_code +".css?"+ makeTimeStamp() );
    ...
    $('#switcher-menu-style').on('change', function (e) {
        ...
        $("#menuzord-menu-skins").attr("href", "assets/" + menuzord_skins_folder_url + valueSelected +".css?"+ makeTimeStamp() );
    ...
    $('#switcher-bgcolor a').on('click', function(e) {
        ...
        if( bgcolor == "dark" ) {
            ...
            $('<link href="assets/css/style-main-dark.css?'+ makeTimeStamp() +'" rel="stylesheet" type="text/css" id="link-style-main-dark">').appendTo('body');
            $('#header .menuzord-brand img').attr('src','assets/images/logo-wide-white.png');
        } else if( bgcolor == "light" ) {
            $('body').removeClass('dark');
            $('#header .menuzord-brand img').attr('src','assets/images/logo-wide.png');
        }
        return false;
    });
    ...
    $('#switcher-rtl a').on('click', function(e) {
        ...
        if( direction_type == "rtl" ) {
            ...
            $('<link href="assets/css/style-main-rtl.css?'+ makeTimeStamp() +'" rel="stylesheet" type="text/css" id="link-style-main-rtl">').appendTo('body');
            $('<link href="assets/css/style-main-rtl-extra.css?'+ makeTimeStamp() +'" rel="stylesheet" type="text/css" id="link-style-main-rtl-extra">').appendTo('body');
            $('<link href="assets/color-switcher/css/color-switcher-rtl.css" rel="stylesheet" type="text/css" id="link-switcher-rtl">').appendTo('body');
    ...
    $('#button-reset2 a').on('click', function(e) {
        ...
        $("#link-colors-style").attr("href", "assets/" + theme_skin_folder_url + "yellow.css");
    ...
    $.getScript('//docs.kodesolution.info/html-list/item-list.js', function() {
        var item = calendarEvents['medinova'];
        ...
        $("#purchase-html-url").attr("href", "assets/" + html_url);
